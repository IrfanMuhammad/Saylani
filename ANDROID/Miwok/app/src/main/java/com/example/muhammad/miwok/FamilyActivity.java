...
public class FamilyActivity extends AppCompatActivity {
    ...
    //    The listener gets triggered when the {@link mediaplyer} has completed
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    // release the media player if its currently exists because
                    //we are about to play a different sound file
                    mMediaPlayer = MediaPlayer.create(FamilyActivity.this, word.getAudioResourceId());
                    mMediaPlayer.start();

                    // setup a listener on media palyer, so that we can stop and release  the
